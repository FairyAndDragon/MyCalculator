...
{
    class OperationDivide:Operation,ICalculator
    {
        public OperationDivide(string numberA, string numberB) : base(numberA, numberB)
        {
        }
        ...
        public override string GetResult()
        {
            ...
            string sum = null;
            ICalculator calculator = new OperationDivide();
