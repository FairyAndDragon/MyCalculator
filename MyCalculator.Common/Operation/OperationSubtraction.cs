...
{
    class OperationSubtraction:Operation,ICalculator
    {
        public OperationSubtraction(string numberA, string numberB) : base(numberA, numberB)
        {
        }
        ...
        public override string GetResult()
        {
            ...
            string sum = null;
            ICalculator calculator = new OperationSubtraction();
